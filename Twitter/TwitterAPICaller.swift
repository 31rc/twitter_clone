...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "SiCcZ8NcrC1Omy1KBhwKWPnIF", consumerSecret: "meenTVrIU3Ht2AU3m16GniiEt3V0hGQB9bxNrGt9GEAP6raEqL")
    var loginSuccess: (() -> ())?
